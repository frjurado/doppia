...
class ErrorCode(StrEnum):
    ...
    # Infrastructure
    GRAPH_SERVICE_UNAVAILABLE = "GRAPH_SERVICE_UNAVAILABLE"
    ...
    FRAGMENT_ALREADY_APPROVED = "FRAGMENT_ALREADY_APPROVED"
    UNREVIEWED_HARMONY = "UNREVIEWED_HARMONY"
    HARMONY_NOT_REVIEWED = "HARMONY_NOT_REVIEWED"
    REPORT_ALREADY_OPEN = "REPORT_ALREADY_OPEN"
    REPORT_ALREADY_RESOLVED = "REPORT_ALREADY_RESOLVED"
    SELF_ADMIN_REVOCATION = "SELF_ADMIN_REVOCATION"
